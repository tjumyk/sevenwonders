...
public class SimpleResList implements Serializable {
     ...
     * Instantiates a new simple res list.
     *
     * @param sl another simple resource list
     */
     ...
     * 建立花费的资源的清单
     *
     * @param thing Any Buildable things.任何Buildable的对象
     ...
     *
     * @param resList the resource list.资源表
     ...
     *
     * @param resList the resource list.传入的资源列表。
     ...
     * Subtract.
     *
     * @param resList1 the res list1
     * @param resList2 the res list2
