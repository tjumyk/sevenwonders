...
public class CommandOption {
     ...
     * 建立一个新的命令选项。
     *
     * @param crd     the card.卡牌
     * @param ndBuy   amount of resources need to buy.需要购买的资源的数量
     * @param needs   the needed resources.需要的资源
     * @param left    the resource list of the left-neighboring board.左边相邻奇迹（板）所拥有资源的清单
     * @param right   the resource list of the right-neighboring board.右边相邻奇迹（板）所拥有资源的清单
     * @param bldable whether available to build.是否可以建造
     * @param free    whether it's free to build.是否可以免费建造
     */
     ...
     *
     * @param canBldStage the new can build stage
     */
     ...
     *
     * @param availableFree the new available free
     */
     ...
     * Sets the left srl.
     *
     * @param leftSRL the new left srl
     */
     ...
     * Sets the right srl.
     *
     * @param rightSRL the new right srl
     */
