...
//changebhcs
     ...
     * 设置奇迹的序号
     *
     * @param index the index of the board. 奇迹序号
     */
     ...
     * 带有3个参数的构造函数
     *
     * @param name      the name of the board(wonder).奇迹（板）名称
     * @param initRes   the initial resource.初始资源
     * @param numStages the number of stages.奇迹级别数(2-4)
     */
     ...
     * 将这张卡牌加入该奇迹（板）的建筑群中。
     *
     * @param c the card need to add in。需要加入的卡牌
     */
     ...
     *
     * @param cmdOps the command options.可选的命令选项
     ...
     * 实现这个命令选项。
     *
     * @param cmdOpt the command option.需要实现的命令选项
     */
...
//			}
     ...
     * 奇迹调用玩家来做出选择，并实现该选择。
     *
     * @param hand   the hand deck.分得的手牌堆
...
//		}
     ...
     * question
     *
     * @param bld      the card attempt to build.尝试建造的建筑。
     * @param cardCost the cost to build the card.建造该建筑所需代价。
...
//		return canAfford;
     ...
     *
     * @param bld       the bld
     * @param stageCost the stage cost
     ...
     * 增加一个奇迹的胜利点数。
     *
     * @param more the more victory points to add.增加的新胜利点数
     */
     ...
     * 设置左侧相邻奇迹
     *
     * @param leftNeighbor the new left neighbor。新的左侧相邻奇迹
     */
     ...
     * 设置右侧相邻奇迹
     *
     * @param rightNeighbor the new right neighbor。新的右侧相邻奇迹
     */
     ...
     * 设置奇迹级别。
     *
     * @param stg the new stage。新的奇迹级别
     */
     ...
     * compass, 2 = tablet
     *
     * @param symbols the science symbols。科技牌中的科技符号
     ...
     * 弃掉一张牌。
     *
     * @param card the card to be discarded.要弃掉的牌。
     */
